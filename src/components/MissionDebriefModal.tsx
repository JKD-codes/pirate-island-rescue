...
export default function MissionDebriefModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fade-in">
      <div className="w-full max-w-lg bg-[#0b1329] border-2 border-amber-400/70 rounded-xl shadow-[0_0_80px_rgba(245,158,11,0.25)] overflow-hidden font-mono text-xs">
        {/* Top Gold Banner */}
        <div className="bg-gradient-to-r from-amber-500/30 via-amber-400/20 to-amber-500/30 border-b border-amber-500/40 px-5 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <Trophy className="text-amber-400 animate-bounce" size={20} />
            <div>
              <h2 className="text-sm font-bold uppercase tracking-[0.18em] text-amber-200">
                Captain's Council // Mission Debrief
              </h2>
              <p className="text-[10px] text-amber-300/70 uppercase tracking-widest">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="bg-emerald-950/40 border border-emerald-500/50 rounded-lg p-3.5 flex items-center gap-3 shadow-[0_0_20px_rgba(16,185,129,0.15)]">
